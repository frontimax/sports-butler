...
You can show all endpoints with:

    Sports::Butler.show_endpoints

Overview of all endpoints of all APIs with required and optional parameters:
...
|                         | [[:keyreq, :id], [:keyreq, :year], [:key, :filters]]        | [[:keyreq, :id], [:keyreq, :year], [:key, :filters]] | [[:keyreq, :id], [:keyreq, :year], [:key, :filters]] |
+-------------------------+-------------------------------------------------------------+------------------------------------------------------+------------------------------------------------------+
| by_team                 | YES                                                         | YES                                                  | -                                                    |
...
|                     | -                                  | [[:keyreq, :id], [:keyreq, :from], [:keyreq, :to], [:key, :filters]] | -                                  |
+---------------------+------------------------------------+----------------------------------------------------------------------+------------------------------------+
...
|                         | -                                  | -                                  | [[:keyreq, :id], [:keyreq, :year], [:key, :filters]] |
+-------------------------+------------------------------------+------------------------------------+------------------------------------------------------+
